...
import (
	...
	"github.com/hypnosisfoundation/go-hypnosis/crypto/signify"
	"github.com/hypnosisfoundation/go-hypnosis/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/hypnosisfoundation/go-hypnosis/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/hypnosisfoundation/go-hypnosis/mobile")
